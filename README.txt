...
a persistence unit "examen63pautePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examen63paute/pom.xml":
...
artifact ("examen63paute.war") is already built. You can build
